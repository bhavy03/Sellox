...
const Login = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch("https://sellox.vercel.app/user/login", {
                method: "POST",
                headers: {
        ...
        <>
            <div className="bg-white w-full">
                <div className="w-full relative flex ">
                    <div className="flex min-h-full flex-1 flex-col justify-center align-top px-6 py-2 lg:px-8 relative top-10">
                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    <div className="bg-white w-2/3 text-red-600">
                                        {errorData}
                                    </div>
                                </div>
