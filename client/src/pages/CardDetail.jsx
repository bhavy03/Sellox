        ...
        <>
            {isAuthenticated ?
                <div className="flex justify-center bg-white w-full h-screen p-4">
                    <div className="w-full md:grid md:grid-cols-5 md:grid-rows-7 md:gap-3 shadow-lg px-4 flex flex-col h-full">
                        ...
                        <div className="col-start-4 col-end-6 row-start-1 row-span-2 rounded-lg shadow-xl p-3 border border-[#dadada] md:h-full h-1/4">
                        ...
                        <div className="col-start-4 col-end-6 row-start-3 row-span-2 rounded-lg shadow-xl p-3 border border-[#dadada] md:h-full h-1/4 md:grid flex flex-col justify-start">
